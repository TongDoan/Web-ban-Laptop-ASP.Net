    ...
    public class ShoppingCartController : Controller
    {
        ...
        public ActionResult CheckOut(OrderViewModel req)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cart != null)
                {
                    ...
                    WebBanHangOnline.Common.Common.SendMail("ShopDoanLatop", "Đơn hàng #" + order.Code, contentCustomer.ToString(), req.Email);
                    ...
                    WebBanHangOnline.Common.Common.SendMail("ShopDoanLatop", "Đơn hàng mới #" + order.Code, contentAdmin.ToString(), ConfigurationManager.AppSettings["EmailAdmin"]);
                    cart.ClearCart();
        ...
        public ActionResult AddToCart(int id, int quantity)
        {
            ...
            if (checkProduct != null)
            {
                ...
                Session["Cart"] = cart;
                code = new { Success = true, msg = "Đã thêm sản phẩm vào giở hàng!", code = 1, Count = cart.Items.Count };
            }
            return Json(code);
        }
        ...
        public ActionResult Update(int id, int quantity)
        {
            ...
            if (cart != null)
            {
                ...
                {
                    code = new { Success = true, msg = "ok"};
                }
                else
                {
                    code = new { Success = false, msg = "Sản phẩm trong kho không đủ!" };
